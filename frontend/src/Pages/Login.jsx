...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="container h-[35vh] mt-24 border-r-2 shadow-md pt-12 flex flex-col items-center justify-center">
        <div className="flex flex-col gap-4">
          <input
            ...
            className="border-black  h-10 w-[60vw] rounded-md pl-2 outline-none"
      ...
      <div className="shadow-md container h-[8vh] mt-4 border-r-2 flex items-center justify-center">
